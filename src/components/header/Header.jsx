...
const Header = () => {
  ...
  return (
    ...
    <ul className={'hidden md:flex gap-8  justify-around  text-xm text-center font-semibold '}>
      <ThemeController />
          <Link href={'/'}>
          ...
          <Link href={'/events'}>
            <li className="hover:text-blue-600 cursor-pointer text-primary">Events</li>
          </Link>
          <Link href={'/medals'} >
            <li className="hover:text-blue-600 cursor-pointer text-primary">
            Medals
          ...
          <Link href={'https://docs.apis.codante.io/'} target='_blank'>
            <li className="hover:text-blue-600 cursor-pointer text-primary">APICODANTE</li>
          </Link>
          </ul>
  </div>
  )
